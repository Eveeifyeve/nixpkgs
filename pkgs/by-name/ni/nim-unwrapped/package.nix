...
stdenv.mkDerivation (finalAttrs: {
  ...
  passthru =
    let
      deprecatedNimPlatform = builtins.trace "nimHost & nimTarget is deprecated, use stdenv.hostPlatform.nim.os & stdenv.hostPlatform.nim.cpu instead" stdenv.hostPlatform.nim;
    in
    {
      nimHost = deprecatedNimPlatform;
      nimTarget = deprecatedNimPlatform;
    };
